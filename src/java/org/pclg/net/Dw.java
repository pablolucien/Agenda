...
//	};
	...
	/** Tamaño del pool de threads a usar para las descargas. */
	private int poolSize;

	/**
	 * @param args los parámetros a usar:<br>
	 ...
	 *
	 * @throws java.io.IOException si hay algún problema
	 */
...
// IDEA-114997 (Bug) (IDEA 13: inspection to replace StringBuilder with String is incorrect)
	...
	final class Dwldr extends Thread {
		...
		/** Qué vamos a bajar y donde lo ponemos. */
	...
	/**
	 * "Struct" para almacenar la información de los targets.
	 */
