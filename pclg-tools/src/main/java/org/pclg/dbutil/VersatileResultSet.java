 ...
 * @since 01/06/2020.
 */
public class VersatileResultSet implements ResultSet {
    private static final Logger LOGGER = LoggerFactory.makeLog4J();
    private final ResultSet delegate;
    private final List<String> params = new ArrayList<>();
    private static final String MESSAGE = "Executing: %s with params: %s";

    public VersatileResultSet(final ResultSet rset) {
        delegate = rset;
    }
    ...
    public void updateNull(final int columnIndex) throws SQLException {
        ...
        saveParameter(columnIndex, "<null>");
    }

    @Override
    public void updateBoolean(final int columnIndex, final boolean x) throws SQLException {
        delegate.updateBoolean(columnIndex, x);
        saveParameter(columnIndex, String.valueOf(x));
    }
    ...
    public void updateString(final int columnIndex, final String x) throws SQLException {
        ...
        saveParameter(columnIndex, x);
    }

    @Override
    public void updateBytes(final int columnIndex, final byte[] x) throws SQLException {
        delegate.updateBytes(columnIndex, x);
        saveParameter(columnIndex, Arrays.toString(x));
    }
    ...
    public void insertRow() throws SQLException {
        LOGGER.debug(String.format(MESSAGE, "insertRow()", params));
        delegate.insertRow();
    }

    @Override
    public void updateRow() throws SQLException {
        LOGGER.debug(String.format(MESSAGE, "updateRow()", params));
        delegate.updateRow();
    }

    @Override
    public void deleteRow() throws SQLException {
        LOGGER.debug(String.format(MESSAGE, "deleteRow()", params));
        delegate.deleteRow();
    }

    @Override
    public void refreshRow() throws SQLException {
        LOGGER.debug(String.format(MESSAGE, "refreshRow()", params));
        delegate.refreshRow();
    }

    @Override
    public void cancelRowUpdates() throws SQLException {
        LOGGER.debug(String.format(MESSAGE, "cancelRowUpdates()", params));
