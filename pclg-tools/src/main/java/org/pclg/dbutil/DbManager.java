...
//    private static final String driverClassName = "sun.jdbc.odbc.JdbcOdbcDriver";
    ...
    public Connection getConnection(final String driverClassName, final String connectString, final String user, final String pwd)
        ...
        if (driverClassName != null) {
            try {
                ...
                LOGGER.warn(String.format("driver class %s not found, but going ahead nevertheless%n", driverClassName));
            }
        }
    ...
    /**
     * Verifica la existencia de las tablas de la aplicaci�n y las crea si no
     * existen.
