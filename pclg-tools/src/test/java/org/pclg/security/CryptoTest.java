...
public class CryptoTest {
    ...
    public void setUp() throws IOException {
        ...
        FileTools.writeToFile("La donna � mobile".getBytes(), testFile, true);
    ...
    @Test(expectedExceptions = SecurityException.class, expectedExceptionsMessageRegExp = ">>>> La contrase�a no es correcta <<<<")
