...
//							pages.add(page);
//							page.add("Listado de teléfonos. Página " + (pageNr + 1) + " de " + totalPages);
//							page.add("----------- \n");
...
//			}
	...
	@Override
	public void actionPerformed(final ActionEvent e) {
		tabbedPane.remove(this);      // Hay más referencias ? Ver si se ejecuta finalize()
