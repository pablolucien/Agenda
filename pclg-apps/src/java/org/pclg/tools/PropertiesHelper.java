...
public class PropertiesHelper {
	...
	public static void loadProperties(final Properties properties, final String baseName) {
		...
		// _custom cargarla después de _technical para que sus valores tengan preferencia.
	 ...
	 *
	 * @param properties dónde se van a buscar los recursos.
	...
	public static void saveBounds(final BoundsInfo boundsInfo, final Properties properties, final String prefix) {
		...
		if (!bounds.equals(BoundsInfo.NULL_RECTANGLE)) {        // Si no están todos en cero
