...
public final class Splitter {
    ...
    /** El tamaño de un archivo para que quepa en un diskette. */
    ...
    private static void usage() {
        ...
        emit("       donde <n> es el tamaño del archivo");
        ...
        emit("");
        emit("       -f y -F indican usar como tamaño el espacio");
    ...
    public static void main(final String[] args) {
        ...
        if (args[0].equalsIgnoreCase("-size")) {
            try {
                ...
                if (DEBUG) {
                    emit(MessageFormat.format(
							"Utilizando un tamaño de {0} bytes", size));
                }
                firstArg = 2;
            ...
            firstArg = 2;
            emit(MessageFormat.format(
					"Utilizando el tamaño libre en {1} de {0} bytes",
					size, args[1]));
        }
        ...
        if (size <= 0) {
            ...
            emit(MessageFormat.format(
					"Utilizando el tamaño por omisión de {0} bytes",
					DISKETTE_FILE_SIZE));
        }
     ...
     * @param splitSize El tamaño de los pedazos resultantes
     */
