...
public class AtomicLong extends Thread {
    ...
    private AtomicLong(final int k) {
        final long temp = k;
        key = (temp << 32) | temp;
    }
	...
	public void run() {
        for (int i = 0; i < count; i++) {
            final long temp = v;
            final long temp1 = temp >>> 32;
            final long temp2 = (temp << 32) >>> 32;
            final long temp3 = 0xffffffffL & temp;
            ...
            if (temp1 != temp3) {
                System.out.println(
                        "Nonatomic write to or read from a volatile long.\n\n" +
