...
public class CoherenceVolatile {
    private static boolean sawNonvolatileViolation;
    static class VPoint {
	volatile int x;
	volatile int y;
    }

    private static final VPoint vp = new VPoint();
    private static final VPoint vq = vp;

    private static void checkVolatile() {
    ...
    private static final Point q = p;
