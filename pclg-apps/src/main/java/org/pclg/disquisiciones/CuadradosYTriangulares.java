...
/**
 * Clase para resolver el enigma de Numberphile de si hay m�s n�meros a la vez
 * triangulares (x = m * (m + 1) / 2) y cuadrados (x = n * n) adem�s del 36.
 *
 * Si los hay, �cu�l es el patr�n?
 *
 * Puzzle Is 36 the only triangle-square number.mp4
 *
 * Para encontrarlos buscamos los puntos en que ambas funciones tomen
 * valores que est�n en el rango de ambas.
 *
