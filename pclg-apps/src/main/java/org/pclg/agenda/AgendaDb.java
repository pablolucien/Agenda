...
public interface AgendaDb {
	...
	/**
	 * Busca los registros segun la cl�usula WHERE que se le pase.
	 * @param whereClause la cl�usula WHERE a usar.
	 * @param orderByClause la cl�usula ORDER BY a usar.
	 * @return los registros segun la cl�usula WHERE que se le pase.
	 * @throws SQLException Si hay problemas.
	 */
