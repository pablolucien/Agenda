...
public final class TipoTelefonoUpdater implements Plugin {
    ...
    /**
   	 * Actualiza lo tipos de los tel�fonos a partir de una lista de tipo
   	 * <nro de tel�fono>:<tipo> contenida en un fichero (uno por l�nea).
   	 *
   	 *
     *
     * @param dbConnection la conexi�n a usar.
