...
/**
 * Clase encargada de la criptograf�a, pero que no hace nada.
 *
 * @author El Coyote
...
public final class DummyCrypto implements Cryptographer {
	...
	public static void main(final String[] args) {
		final String sql = "('058','Venezuela'),('033','France'),('034','Espa�a'),('044','England'),('046','Sverige'),('001','USA'),('049','Deutschland'),('055','Brasil'),('054','Argentina'),('052','Mexico'),('043','�sterreich')";
