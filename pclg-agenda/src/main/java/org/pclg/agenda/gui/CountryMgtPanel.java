...
public final class CountryMgtPanel extends JPanel {
	...
	private final AgendaDb agendaDb; // FIXME: no se si esto debe estar aqu� o en Pais o d�nde
...
//			phoneMaskField.setBackground(Color.lightGray);
			...
			button.addActionListener(e -> {
				...
				if (isEmptyOrBlank(code)) {
					final String msg= "Tratando de agregar Pais con c�digo vac�o. No hago nada";
					message.setText(msg);
					LOGGER.warn(msg);
						return;
				}
				...
				if (isEmptyOrBlank(name)) {
					final String msg = "Tratando de agregar Pais con nombre vac�o. No hago nada";
					message.setText(msg);
					LOGGER.warn(msg);
						return;
				}
